        ...
        api.bulkDocs = function(req, opts, callback) {
            ...
            var writeDoc = function(docInfo, callback) {
                ...
                dataReq.onsuccess = function(e) {
                    ...
                    // out on read
                    docInfo.metadata.rev = winningRev(docInfo.metadata.rev_tree[0].pos, docInfo.metadata.rev_tree[0].ids);
            ...
            var update = function(cursor, oldDoc, docInfo, callback) {
                ...
                var inConflict = (oldDoc.deleted && docInfo.metadata.deleted) || (!oldDoc.deleted && newEdits && mergedRevisions.conflicts !== 'new_leaf');
                if(inConflict) {
        ...
        api.revsDiff = function(req, opts, callback) {
            ...
            function readDoc(err, doc, id) {
                req[id].map(function(revId) {
                    if(!doc || doc._revs_info.every(function(x) {
                        return x.rev !== revId;
                    })) {
                        if(!missing[id]) {
                            missing[id] = {
        ...
        var viewQuery = function(fun, idb, options) {
            ...
            request.onsuccess = function(e) {
                ...
                if(!cursor) {
                    ...
                    var nreq = txn.objectStore(BY_SEQ_STORE).get(e.target.result.value.seq).onsuccess = function(e) {
